...
//   d="m 21.404635,64.784375 0.1243,1.12295 -0.87118,1.08171 -0.29058,1.70599 -0.58116,0.24933 -0.49774,-2.57866 -0.33182,-0.91486 0.29058,-0.58247 z m -3.85853,0.0832 0.6224,1.74685 1.3273,2.57867 -0.33182,2.37095 -0.95423,-2.66209 -0.78738,-1.49734 z m 4.97811,-2.37039 -0.95423,5.11609 0.62241,-0.33295 0.49773,1.66381 z" />
  ...
  <div class="human-body">
    <svg data-position='head' id='head' class='head group-hover' xmlns='http://www.w3.org/2000/svg' width='56.594' height='95.031' viewBox='0 0 56.594 95.031'><path d='M15.92 68.5l8.8 12.546 3.97 13.984-9.254-7.38-4.622-15.848zm27.1 0l-8.8 12.546-3.976 13.988 9.254-7.38 4.622-15.848zm6.11-27.775l.108-11.775-21.16-14.742L8.123 26.133 8.09 40.19l-3.24.215 1.462 9.732 5.208 1.81 2.36 11.63 9.72 11.018 10.856-.324 9.56-10.37 1.918-11.952 5.207-1.81 1.342-9.517zm-43.085-1.84l-.257-13.82L28.226 11.9l23.618 15.755-.216 10.37 4.976-17.085L42.556 2.376 25.49 0 10.803 3.673.002 24.415z'/></svg>
    ...
    <svg 
    data-position='left-upper-leg' id='left-upper-leg' class='left-upper-leg group-hover' 
    xmlns='http://www.w3.org/2000/svg' 
    ...
    <svg 
      data-position='left-lower-leg' id='left-lower-leg' class='left-lower-leg group-hover' 
      xmlns='http://www.w3.org/2000/svg' 
    ...
    <svg 
      data-position='right-upper-leg' id='right-upper-leg' class='right-upper-leg group-hover' 
      xmlns='http://www.w3.org/2000/svg' 
    ...
    <svg 
      data-position='right-lower-leg' id='right-lower-leg' class='right-lower-leg group-hover' 
      xmlns='http://www.w3.org/2000/svg' 
      width='93.626' height='150.625' 
      viewBox='0 135 93.626 150.625'>
        <path d='
